...
import { Box, Button, Card, CardContent, FormControl, IconButton, InputAdornment, InputLabel, OutlinedInput, TextField, Typography, Alert, Snackbar } from '@mui/material'
      ...
      <Card sx={{ zIndex: 1, p: 3 }}>
        <CardContent>
          ...
          <form autoComplete='off' onSubmit={(e) => handleLogin(e)}>
            <TextField required autoFocus fullWidth id='email' label='Email' type='email' value={email} onChange={(e) => setEmail(e.target.value)} sx={{ marginBottom: 4 }} />
